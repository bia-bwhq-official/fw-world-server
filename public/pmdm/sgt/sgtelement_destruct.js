...
function Destruction(){
	...
	if(eee==="1"){
		var x, i;   x = document.querySelectorAll("*");   for (i = 0; i < x.length; i++) {x[i].style.userSelect = "none"};
		var x, i;   x = document.querySelectorAll("a");   for (i = 0; i < x.length; i++) {x[i].href = "#"};
